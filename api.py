...
from btc_predictor import config
from btc_predictor.models.predict import predict
from btc_predictor.response_handler import APIResponseHandler

ALLOWED_EXTENSIONS = {'png', 'jpg', 'jpeg', 'pdf', 'xlsx'}

app = Flask('BTC_PREDICTOR')
app.config['UPLOAD_FOLDER'] = config.DATA_FOLDER
router = '/Btc_Predictor/' + config.ENV
...
def hello():
    return 'Hello from BTC_PREDICTOR!'
